...
class main
{
  ...
  public function __construct()
 {
  ...
  $text .= "<h2>Inserting a record for id 14</h2>";
  $record = new account();
  $record->email="abcpqr@njit.edu";
  $record->fname="ABC";
  $record->lname="PQR";
  $record->phone="9876543210";
  $record->birthday="1994-08-01";
  $record->gender="male";
  ...
  $text .= "<h2>Updating the record for id 14</h2>";
  $record = new account();
  $record->id='14'; 
  ...
  $text .= "<h2>Deleting for the record for id 14</h2>";
  $record=new account();
  $record->id=14;
  $record->delete();
  $records = accounts::findAll();
